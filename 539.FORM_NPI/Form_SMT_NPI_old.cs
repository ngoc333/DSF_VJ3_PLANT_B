...
namespace FORM
{
	...
	/// </summary>
	public class Form_SMT_NPI_old : System.Windows.Forms.Form
    {
        ...
        public Form_SMT_NPI_old(string line_cd)
        {
            //
            // Windows Form µðÀÚÀÌ³Ê Áö¿ø¿¡ ÇÊ¿äÇÕ´Ï´Ù.
            //
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form_SMT_NPI_old));
        ...
        private DataTable SEL_DATA(string div, string arg_line_cd, string arg_season_cd,string arg_td_code, string arg_model_cd)
        {
            ...
            try
            {
                ...
                MyOraDB.Parameter_Values[1] = arg_line_cd;// "202";
