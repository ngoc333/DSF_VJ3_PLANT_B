...
namespace FORM
{
    public partial class FRM_SMT_MON_PROD_STATUS : Form
    {
        public FRM_SMT_MON_PROD_STATUS()
        {
            InitializeComponent();
        }
        int indexScreen;
        ...
        public FRM_SMT_MON_PROD_STATUS(string title, int _indexScreen, string _line, string _mline,string _Lang)
        {
            InitializeComponent();
