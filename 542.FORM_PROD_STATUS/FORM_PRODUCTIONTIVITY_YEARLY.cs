...
namespace FORM
{
    public partial class FORM_PRODUCTIONTIVITY_YEARLY : Form
    {
        
    

        public FORM_PRODUCTIONTIVITY_YEARLY()
        {
            InitializeComponent();
       ...
       #endregion
       Form[] arrForm = new Form[4];
       public FORM_PRODUCTIONTIVITY_YEARLY(string Title, int _indexScreen, string line_cd, string mline_cd,string _Lang)
        {
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                FORM_PRODUCTIONTIVITY_DAILY f = new FORM_PRODUCTIONTIVITY_DAILY(Caption, 1, _line_cd, _mline_cd, Lang);
                f.Show();
                //f.TopMost = true;
            }
            timer1.Stop();
