    ...
    public partial class DSF_VJ3_MENU : Form
    {
        ...
        // production / plant
         ...
         private DataTable dtPUPLayout()
         {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_VJ3.SP_VJ3_PLANTB_MENU";
                ...
                MyOraDB.Parameter_Values[0] = "VJ3_B";
            ...
            /*
             ...
             dt.Rows.Add("202", "001", "Plant LE\n(1 - 2)", "0", "1");
             dt.Rows.Add("202", "002", "Plant LE\n(3 - 4)", "0", "2");
             dt.Rows.Add("202", "003", "Plant LE\n(5 - 6)", "0", "3");
             dt.Rows.Add("202", "004", "Plant LE\n(7 - 8)", "1", "0");
        ...
        public DataTable SEL_IMG()
        {
            ...
            try
            {
                ...
                MyOraDB.Parameter_Values[1] = "302";
                MyOraDB.Parameter_Values[2] = "";
                ...
                if (ccountN == 0)
                {
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            UC.UC_MENU_DSF_2 MENU_WS = new UC.UC_MENU_DSF_2(dt.Rows[i]["LINE_NM"].ToString().Replace("_","\n"), dt.Rows[i]["LINE_CD"].ToString(), dt.Rows[i]["LINE_CD1"].ToString(), ComVar.Var._strValue3, (i+1).ToString("000"));
