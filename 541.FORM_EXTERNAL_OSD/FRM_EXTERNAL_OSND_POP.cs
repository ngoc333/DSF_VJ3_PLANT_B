...
namespace FORM
{
    public partial class FRM_EXTERNAL_OSND_POP : Form
    {
        private string line_cd, mline_cd, date_from, date_to;
        public FRM_EXTERNAL_OSND_POP()
        {
            InitializeComponent();
        }
        public FRM_EXTERNAL_OSND_POP(string _line_cd, string _mline_cd, string _date_from, string _date_to)
        {
            InitializeComponent();
            line_cd = _line_cd;
            mline_cd = _mline_cd;
